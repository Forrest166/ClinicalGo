    ...
    while True:
        ...
        try:
            ...
            if exc.code == 429 and rate_limit_attempt < max_rate_limit_retries:
                ...
                sleep_seconds = retry_after if retry_after is not None else max(
                    5.0, retry_delay * (rate_limit_attempt + 1)
                )
            ...
            raise TransportError(
                ...
                f"Try reducing batch size or increasing timeout. Details: {exc}"
            ) from exc
